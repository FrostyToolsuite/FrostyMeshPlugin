...
namespace FrostyMeshPlugin.Gltf.AutoGenerated {
    ...
    [System.Text.Json.Serialization.JsonConverter(typeof(MaterialNormalTextureInfoConverter))]
    public class MaterialNormalTextureInfo {
        ...
        public class MaterialNormalTextureInfoConverter : JsonConverter<MaterialNormalTextureInfo> {
            
            public override bool CanConvert(System.Type typeToConvert) {
                return (typeof(MaterialNormalTextureInfo) == typeToConvert);
            }
            
            public override MaterialNormalTextureInfo Read(ref Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options) {
                if ((reader.TokenType != JsonTokenType.StartObject)) {
                    throw new JsonException();
                }
                MaterialNormalTextureInfo foo = new MaterialNormalTextureInfo();
                for (
                ; true; 
                ) {
...
break;
                    ...
                    if ((reader.TokenType == JsonTokenType.PropertyName)) {
                        ...
                        if ((propertyName == "scale")) {
                            foo.Scale = System.Text.Json.JsonSerializer.Deserialize<float>(ref reader, options);
                        }
            ...
            public override void Write(System.Text.Json.Utf8JsonWriter writer, MaterialNormalTextureInfo value, System.Text.Json.JsonSerializerOptions options) {
