...
namespace FrostyMeshPlugin.Gltf.AutoGenerated {
    ...
    [System.Text.Json.Serialization.JsonConverter(typeof(TextureInfoConverter))]
    public class TextureInfo {
        ...
        public class TextureInfoConverter : JsonConverter<TextureInfo> {
            
            public override bool CanConvert(System.Type typeToConvert) {
                return (typeof(TextureInfo) == typeToConvert);
            }
            
            public override TextureInfo Read(ref Utf8JsonReader reader, System.Type typeToConvert, System.Text.Json.JsonSerializerOptions options) {
                if ((reader.TokenType != JsonTokenType.StartObject)) {
                    throw new JsonException();
                }
                TextureInfo foo = new TextureInfo();
                for (
                ; true; 
                ) {
...
break;
            ...
            public override void Write(System.Text.Json.Utf8JsonWriter writer, TextureInfo value, System.Text.Json.JsonSerializerOptions options) {
